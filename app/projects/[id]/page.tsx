...
const projects = [
  ...
  },
  {
    ...
    team: [
      ...
      { name: "Noelle Tran", role: "Front-End Developer" },
      ...
      { name: "Anya Patel", role: "Back-End Developer" },
      { name: "Ashni Kumar", role: "Back-End Developer" },
      { name: "Ivin Mathew", role: "Cloud Infrastructure Team" },
      { name: "Dior White", role: "Cloud Infrastructure" },
      { name: "Kartik Ohlan", role: "Cloud Infrastructure" },
